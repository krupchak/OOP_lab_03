...
{
    /// <inheritdoc />
    public partial class FootballDetting : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Initials = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AwayTeamBetRate = table.Column<float>(type: "REAL", nullable: false),
                    AwayTeamGoals = table.Column<int>(type: "INTEGER", nullable: false),
                    AwayTeamId = table.Column<int>(type: "INTEGER", nullable: false),
                    DrawBetRate = table.Column<float>(type: "REAL", nullable: false),
                    HomeTeamBetRate = table.Column<float>(type: "REAL", nullable: false),
